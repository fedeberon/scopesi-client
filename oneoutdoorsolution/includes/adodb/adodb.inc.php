...
*/
	...
	var $databaseType = 'mysqli';		/// RDBMS currently in use, eg. odbc, mysql, mssql
	var $database = 'sistema_web';			/// Name of database to be used.
  var $host = 'scopesi.cluster-coklxqif6wnp.us-west-2.rds.amazonaws.com';
  var $user = 'root'; 			/// The username which is used to connect to the database server.
	var $password = 'admScopesi15849!'; 		/// Password for the username. For security, we no longer store it.
	// var $host = '190.210.180.187'; 			/// The hostname of the database server
	// var $user = 'sistemaweb'; 			/// The username which is used to connect to the database server.
	// var $password = 'viapublica2012'; 		/// Password for the username. For security, we no longer store it.
